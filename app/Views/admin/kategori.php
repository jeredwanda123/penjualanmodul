            ...
            <ul class="nav nav-secondary">
              <li class="nav-item active">
                ...
                >
                  ...
                  <p href="../demo1/index.html">Dashboard</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                ...
                >
                  ...
                  <p href="../demo1/index.html">Stok Modul</p>
                </a>
              </li>
              <li class="nav-item">
                ...
                >
                  <i class="fas fa-table"></i>
                  <p href="../demo1/index.html">modul praktikum</p>
                </a>
              </li>
              <li class="nav-item">
          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-2">jered imanuel wanda</h6>
              </div>
            </div>
            <div class="row">
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">opa opa</p>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">jered wanda</p>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">om han</p>
                ...
                <div class="card card-stats card-round">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          <p class="card-category">kk deni</p>
...
<div>
    ...
    <!-- Kaiadmin JS -->
    <script src="<?= base_url(); ?>/template/assets/js/kaiadmin.min.js"></script>
       <!-- Datatables -->
       <script src="<?= base_url(); ?>/template/assets/js/plugin/datatables/datatables.min.js"></script>
    <script>
